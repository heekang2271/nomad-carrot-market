export default function Home() {
  return (
    <main className="bg-gray-100 h-screen flex items-center justify-center p-5 dark:bg-gray-700">
      <div className="bg-white shadow-lg p-5 rounded-2xl w-full max-w-screen-sm dark:bg-gray-600">
        ...
        <div className="relative">
          ...
          <div className="bg-green-500 absolute rounded-full w-2/3 h-2"></div>
        </div>
